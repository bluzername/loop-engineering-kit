...
<The outcome. Link to SPEC.md.>

## Current status

- **Loop level:** L1 | L2 | L3
- **Round:** <n>
- **Criteria passing:** <C1, C3> / **failing:** <C2, C4>
...
- <Anything waiting on a human or an external dependency.>

## Next action

<The single next thing to do when this loop resumes.>
